					...
					<li class="light-blue dropdown-modal">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<span class="user-info">
								...
								<?php
								echo mb_convert_encoding($row["NombreC"], 'ISO-8859-1', 'UTF-8');
								?>
							</span>
				...
				<div class="page-content">
					...
					<div class="page-header">
						...
						<div class="center">
							...
							<div id="attendanceList center">
								<h2>Lista de Asistencia Actual</h2>
								<div id="attendanceTableContainer">
								</div>
							</div>
							<a href="generar_reporte.php" target="_blank"><button type="button">Generar Reporte</button></a>
						</div>

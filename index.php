...
if (!empty($_POST)) {
	...
	$password_encr = sha1($pass);
	$sql = "SELECT idusuarios FROM usuarios 
	          WHERE  usuario='$user' AND password='$password_encr'";
	...
	if ($rows > 0) {
		...
		echo "<script>
		       alert('El usuario o contraseña con incorrectas');
...
if (isset($_POST["registrar"])) {
	...
	if ($filas > 0) {
		...
		$sqlusuario = "INSERT INTO usuarios(NombreC,Correo,Usuario,password) VALUES('$nombre','$correo','$usuario','$password_encr')";

...
switch ($_GET["op"]) {
	case 'guardaryeditar':
		...
		if (empty($idusuario)) {
			...
			$rspta=$usuario->insertar($nombre,$apellidos,$login,$idtipousuario,$email,$clavehash,$imagen,$usuariocreado,$codigo_persona);
			echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar todos los datos del usuario";
		}
		else {
			$rspta=$usuario->editar($idusuario,$nombre,$apellidos,$login,$idtipousuario,$email,$imagen,$usuariocreado,$codigo_persona);
